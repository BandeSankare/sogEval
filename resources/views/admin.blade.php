...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="assets/pages/img/Sgbs_logo.PNG" width="100" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" method="post" action="{{ url('/login') }}">
                ...
                <div class="form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="email" autocomplete="off" placeholder="E-mail" name="email" value="{{ old('email') }}" /> </div>
                         @if ($errors->has('email'))
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn red pull-right"> Se connecter </button>
                </div>
               
                <div class="forget-password">
                    <h4><a href="{{ url('/password/reset') }}">Mot de passe oublier</a><br>
                        <a href="{{ url('/register') }}" class="text-center"></a></h4>
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2018 &copy;Bande SANKARE SIMPLON AUF DAKAR </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
