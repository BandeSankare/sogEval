...
class CandidatController extends AppBaseController
{
    ...
    {
        $this->candidatRepository->pushCriteria(new RequestCriteria($request));
    ...
    public function store(CreateCandidatRequest $request)
    {
        ...
        Flash::success('Candidat saved successfully.');
    ...
    {
        $candidat = $this->candidatRepository->findWithoutFail($id);
